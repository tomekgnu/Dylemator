...
public class QuestionParser {
    ...
    private int nonmoralIndex = 0;
    private int personalIndex = 0;
    private int nonpersonalIndex = 0;
	...
	DocumentBuilder dBuilder;        
        ...
        try {
            ...
            for(int i = 0;i < dilemmas.getLength();i++){
                ...
                String typeStr = type.getTextContent();
                d.setType(typeStr);
                if(typeStr.equals("nonmoral")){
                    d.setIndex(nonmoralIndex++);
                }
                if(typeStr.equals("personal")){
                    d.setIndex(personalIndex++);
                }
                if(typeStr.equals("nonpersonal")){
                    d.setIndex(nonpersonalIndex++);
                }
