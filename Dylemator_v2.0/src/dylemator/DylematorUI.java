...
public class DylematorUI extends javax.swing.JFrame {
   ...
   // private final PreferencesDialog pd = new PreferencesDialog(this, true);
    ...
    private void initComponents() {
        ...
        allUsersMenuItem.setText("Lista wyników badań");
        ...
        userListMenuItem.setText("Kody użytkowników");
        userListMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                userListMenuItemActionPerformed(evt);
            }
        });
        findMenu.add(userListMenuItem);

        findUserMenuItem.setText("Znajdź wyniki badań");
...
private void createUserDialog(){
    ...
    private void questionsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_questionsMenuItemActionPerformed
       ...
       if(result == JFileChooser.APPROVE_OPTION)
        ...
        qd = new QuestionDialog(this,true);
        qd.setDilemmas(dList);
        qd.clearSelectedDilemmas();
        ...
        try {
            ...
            if(newDate){
                String[] fields = new String[]{"Kod osoby","Data badania","Imię","Nazwisko","Wiek","Płeć","Miejsce zamieszkania",
                                               ...
                                               "Typ decyzji",
                                               "Wagonik (wersja standardowa)",
                                               "Typ decyzji",
                                               "Trujący dym (wersja standardowa)",
                                               "Typ decyzji",
                                               "Polityka szczepień",
                                               "Typ decyzji",
                                               "Oczy",
                                               ...
                                               "Podatki",
                                               "Typ decyzji",
                                               "Wskazówka dotycząca inwestowania",
                                               "Typ decyzji"
              };
...
//                      firstScreen(0);
    ...
    private void allUsersMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allUsersMenuItemActionPerformed
       UserResultList ul = new UserResultList(this,true);
       ul.setVisible(true);
    ...
    private void userListMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userListMenuItemActionPerformed
        CodeList cl = new CodeList(this,true);
        cl.setVisible(true);
